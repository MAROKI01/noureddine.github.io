...
<tbody class="">
    <div class="container justify-content-center align-centent-center">
      <div class="row text-center mt-5 pb-1"><h2 class="fw-bold">Résumé de la date <?php echo $_POST["date"]?></h2></div>
