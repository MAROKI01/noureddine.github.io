      ...
      <div class="container-fluid px-0">
        ...
        <div>
          ...
          <li class="nav-item"><a class="nav-link fw-bold px-5" href="Home_page.html">Home</a></li>
            <li class="nav-item btn-retour"><a class="nav-link fw-bold px-5 " href="Liste_depenses_home.html">Retour</a></li>
...
<tbody class=" ">
  <div class="container">
     <div class="row text-center mt-5">
      <h2 class="fw-bold ">Liste des dépenses </h2>
     </div>
      <div class="row container-fluid row-cols-1 row-cols-md- mt-4 pt-3 mx-md-1 px-md-1 mx-sm-1 px-sm-1 justify-content-center text-center">
